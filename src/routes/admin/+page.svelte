        ...
        <div class="glass-card bg-slate-800/20 backdrop-blur-lg border border-gray-700/30 rounded-2xl shadow-2xl overflow-hidden">
            <div class="border-b border-gray-700/30 bg-slate-800/30 backdrop-blur-lg">
                <nav class="flex space-x-1 p-2 overflow-x-auto">
                    <button
                        class="relative px-6 py-3 rounded-xl font-medium text-sm transition-all duration-300 whitespace-nowrap {activeTab === 'dashboard' ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg' : 'text-gray-300 hover:text-white hover:bg-slate-700/50'}"
                    ...
                    <button
                        class="relative px-6 py-3 rounded-xl font-medium text-sm transition-all duration-300 whitespace-nowrap {activeTab === 'users' ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg' : 'text-gray-300 hover:text-white hover:bg-slate-700/50'}"
                    ...
                    <button
                        class="relative px-6 py-3 rounded-xl font-medium text-sm transition-all duration-300 whitespace-nowrap {activeTab === 'exam-files' ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg' : 'text-gray-300 hover:text-white hover:bg-slate-700/50'}"
                    ...
                    <button
                        class="relative px-6 py-3 rounded-xl font-medium text-sm transition-all duration-300 whitespace-nowrap {activeTab === 'moderation' ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg' : 'text-gray-300 hover:text-white hover:bg-slate-700/50'}"
                    ...
                    <button
                        class="relative px-6 py-3 rounded-xl font-medium text-sm transition-all duration-300 whitespace-nowrap {activeTab === 'analytics' ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg' : 'text-gray-300 hover:text-white hover:bg-slate-700/50'}"
                    ...
                    <button
                        class="relative px-6 py-3 rounded-xl font-medium text-sm transition-all duration-300 whitespace-nowrap {activeTab === 'system' ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg' : 'text-gray-300 hover:text-white hover:bg-slate-700/50'}"
                                        ...
                                        <div class="ml-6">
                                            <label class="relative inline-flex items-center cursor-pointer">
                                                <input
                                                    ...
                                                    on:change={(e) => toggleSystemFeature(feature.key, e.target.checked)}
                                                    class="sr-only peer"
                                                />
